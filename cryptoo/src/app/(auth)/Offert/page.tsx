  ...
  useEffect(() => {
    ...
    return (
      <div className='flex h-full flex-col bg-gradient-to-tl from-gray-900 via-orange-900 to-orange-500 relative'>
        <Header />
        <div className='border mt-60 mb-60'>
        <h1 className='text-3xl text-center TitleOffert'>
          <Link href={'/Crypto'}>Offert</Link>
        </h1>
      ...
      {offersList &&
        offersList?.map((offer) => {
          return (
            <div
              key={offer.id}
              className="border-2 m-8 rounded-md mt-1 p-2 bg-gradient-to-b from-amber-500 to-amber-200 border-black text-black "
            >
