...
const Footer = () => {
  return (
    <div className='border-2 border-orange-600 p-4 rounded-t-full styleFooter text-lg'>
      <div className=''>
      ...
      <div>
            <li className='flex items-center gap-4'>Compagny development front-end website :
