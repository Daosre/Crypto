...
const UserProfils = () => {
  ...
  return (
      ...
      <h1 className='m-4 underline underline-offset-8 absolute top-1/4 text-3xl Myaccount'>My Account : </h1>
          ...
          <div className='border p-2 w-1/4 h-1/4 text-center flex items-center justify-center rounded-lg gap-20 textUser'>
      ...
      <div className='border w-1/4 h-1/4 text-center flex items-center justify-center rounded-lg textUser'>
        <MyCrypto/>
      </div>
    </div>
  )
